		...
		<div class="main">
			...
			<div class="delete_product_nof">
				<div class="delete_product_nof-wp delete-warning ">
					...
					<span>Laptop Lenovo IdeaPad 5 Pro 16ACH6 82L50095VN Laptop Lenovo IdeaPad 5 Pro 16ACH6 82L50095VN </span>
				...
				<form action="" id="sp" class="edit_product-wp">
					...
					<div class="form-content">
						<div class="form-group">
							...
							<input type="text" placeholder="Nhập tên sản phẩm" name="nameproduct" id="nameproduct" required>
						</div>
						<div class="form-group">
							<label for="qtyproduct">
								Số lượng:
							</label>
							<input type="number" placeholder="Nhập số lượng sản phẩm" name="qtyproduct" id="qtyproduct" required>
						</div>
						<div class="form-group">
							<label for="priceproduct">
								Tên sản phẩm:
							</label>
							<input type="number" placeholder="Nhập giá sản phẩm" name="priceproduct" id="priceproduct" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="file" placeholder="Nhập tên sản phẩm" name="imageproduct" id="imageproduct" required>
						</div>
						...
						<table>
							...
							<c:forEach var="item" items="${listProductAD.content}">
								<tr>
									...
									<td>
										<div class="images">
											<img src="./../assets/img/sanpham/${item.hinh}" alt="" width="50px">
										</div>
									</td>
									<td>
										<div class="dropdown">
