...
<div class="topbar blur-white-lg">
    ...
    <div class="action">
        <div class="user" onclick="menuToggle();">
            <!--profile-->
            <img src="https://i.pinimg.com/564x/92/26/5c/92265c40c8e428122e0b32adc1994594.jpg"
                alt="" width="50px">
        </div>
        <div class="menu">
            <h3>${fullnameNV} <br><span>Page Admin</span></h3>
            <ul>
                <li><i class="far fa-user-circle"></i><a href="./profile">My Profile</a></li>
                <li><i class="far fa-edit"></i><a href="./profile">Edit Profile</a></li>
