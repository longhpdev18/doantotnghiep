				...
				<div class="paid-list">
					...
					<div class="paid-list-address">
									...
									<div class="sub-address">
										<div class="faddress-group">
											<label for="fullname">Tên người nhận</label> <input
												type="text" class="txtFullname" name="fullname"
										...
										<div class="faddress-group">
											<label for="phone">Số điện thoại</label> <input type="number"
												class="txtPhone" name="address" placeholder="Số điện thoại"
												required>
										</div>
						...
						<div class="paid-address">
							...
							</label> <input type="radio" class="rdo-address" id="address-2"
								name="rdo-address"> <label class="rdo-address-wp"
								for="address-2">
								<p class="address-nameKH">Hoàng Phi Long</p>
								<p class="address-text">Khu Phố Long Điền 1, Phường Long
									Phước, Thị Xã Phước Long, Tỉnh Bình Phước</p>
								<p class="address-phone">0385818520</p>
							</label> <input type="radio" class="rdo-address" id="address-3"
								name="rdo-address"> <label class="rdo-address-wp"
								for="address-3">
								<p class="address-nameKH">Hoàng Phi Long</p>
								<p class="address-text">Khu Phố Long Điền 1, Phường Long
					...
					<div class="paid-list-content">
						...
						<div class="paid-row">
							<div class="paid-row-image">
								<img
									src="https://cdn.tgdd.vn/Products/Images/44/231255/macbook-pro-m1-2020-gray-600x600.jpg"
