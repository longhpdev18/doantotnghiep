...
insert into sanpham values (N'Cặp Loa kiểm âm JBL 305P MkII',8,5,'10600000',N'Studio Monitor cung cấp chính xác những công cụ bạn cần để đưa bản mix của bạn lên một tầm cao mới.
 Phiên bản 305P MKII được thừa hưởng tất cả các đặc điểm của dòng loa JBL series 3 gốc',0,N'Cặp Loa kiểm âm JBL 305P MkII.jpg')
...
,Loa siêu trầm: 20W,Các loa vệ tinh: 2 x 10W',0,N'Loa vi tính không dây Logitech Z407 2.1.jpg')
...
insert into sanpham values (N'GVN Avengers Z',4,2,'3170000',N'Thông tin đang được cập nhập',0,'GVN Avengers Z.jpg')
insert into sanpham values (N'GVN AXE M',4,3,'1400000',N'Thông tin đang được cập nhập',1,'GVN AXE M.jpg')
insert into sanpham values (N'GVN Ghost S',4,4,'1820000',N'Thông tin đang được cập nhập',0,'GVN Ghost S.jpg')
insert into sanpham values (N'GVN Homework I3',4,5,'8590000',N'Thông tin đang được cập nhập',1,'GVN Homework I3.jpg')
insert into sanpham values (N'GVN Homework I5 (Intel Gen 10)',4,6,'10790000.',N'hàng trung qu?c',1,'GVN Homework I5 (Intel Gen 10).jpg')
...
GVN Titan 10 M  sẽ là một trong những sự lựa chọn tốt nhất trong phân khúc dưới 10 triệu đồng bạn không nên bỏ qua.',0,'GVN Titan 10 M.jpg')
insert into sanpham values (N'GVN Urus X',4,8,'4780000',N'Thông tin đang được cập nhập',1,'GVN Urus X.jpg')
insert into sanpham values (N'GVN Valorant Z',4,9,'3170000',N'Thông tin đang được cập nhập',1,'GVN Valorant Z.jpg')
insert into sanpham values (N'GVN Venus S',4,10,'1820000',N'Đối tượng nhắm đến của bộ GVN này là các bạn học sinh/sinh viên với nhu cầu chơi chủ yếu là các game online(LoL, Dota 2, CSGO,…) max setting. Chơi mượt các game offline (GTA V, Crysis 3,…) ở medium-high. Ngoài ra vẫn có thể chiến tốt game hot hiện nay là PUBG ở mức very low - medium setting',0,'GVN Venus S.jpg')
----
insert into sanpham values (N'Corsair Dominator Platinum',10,9,'7490000',N'Nhà sản xuất: CORSAIR (CMT32GX4M2E3200C16) Loại RAM: DDR4 Dung lượng: 32GB Số lượng: 2 thanh Bus: 3200MHz Tản nhiệt: Có Màu: Trắng Bảo Hành: 36 Tháng.',1,'Corsair Dominator Platinum.png')
insert into sanpham values (N'GIGABYTE Z490 VISION D',10,10,'3500000',N'Sản phẩm: Bo mạch chủ Tên Hãng:GIGABYTE  Model:Z490 VISION D CPU hỗ trợ:Intel.Chipset:Z490',0,'GIGABYTE Z490 VISION D.png')
...
insert into sanpham values (N'RAM PNY XLR8 GAMING',10,8,'1450000',N'Loại RAM: DDR4 Dung lượng: 8GB  Số lượng: 1 thanh Bus: 3200MHz Bảo hành: 36 tháng',0,'RAM PNY XLR8 GAMING.jpg')
insert into sanpham values (N'SSD 660p QLC 512GB',10,9,'2090000',N'Loại RAM: DDR4 Dung lượng: 8GB Số lượng: 1 thanh Bus: 3200MHz Bảo hành: 36 tháng',1,'SSD 660p QLC 512GB.png')
insert into sanpham values (N'SSD KINGSTON A2000 250GB',10,1,'1190000',N'Chuẩn SSD: M.2 NVMe Gen3 x4 Tốc độ đọc: 2000 MB/s,Tốc độ ghi: 1000 MB/s Bảo hành chính hãng 5 năm 1 đổi 1',1,'SSD KINGSTON A2000 250GB.jpg')
...
Hình thức : FPP(ESD) (Full Packaged Product) - sản phẩm có thể kích hoạt khi thay đổi phần cứng.',1,'WIN HOME 10 32-bit64-bit.jpg')
